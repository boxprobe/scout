...
def test_locator_resolve_static_dxy():
    ...
    child = Locator(
        name="inner-btn", tag="button", bbox=(0, 0, 80, 30),
        pos_type="dxy", parent="container",
...
def test_locator_resolve_static_rel_left_top():
    ...
    child = Locator(
        name="label", tag="span", bbox=(0, 0, 60, 20),
        pos_type="rel", parent="panel",
...
def test_locator_resolve_static_rel_right_bottom():
    ...
    parent = Locator(name="panel", tag="div", bbox=(100, 200, 500, 400))
    child = Locator(
        name="close-btn", tag="button", bbox=(0, 0, 30, 30),
        pos_type="rel", parent="panel",
...
def test_locator_resolve_static_missing_parent():
    ...
    child = Locator(
        name="orphan", tag="div", bbox=(10, 20, 30, 40),
        pos_type="rel", parent="nonexistent",
    )
...
def test_locator_repr_rel():
    ...
    loc = Locator(
        name="btn", tag="button", bbox=(0, 0, 50, 30),
        pos_type="rel", parent="container",
    )
    r = repr(loc)
    assert "rel" in r
